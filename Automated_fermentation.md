...
This guide will not go through in detail how to get started with Node-RED if you're not already familiar. There's plenty of guides already. 

Down below, you will find a few example flows that you can copy and experiment with. If you find success with other popular setups, we can add examples for those as well.

### Activating a fermentation profile
Before going through the examples, let's have a few words on how to activate a fermentation profile.
